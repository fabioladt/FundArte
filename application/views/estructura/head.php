...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-110463060-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-110463060-1');
</script>
    ...
    <link rel="stylesheet" href="<?=base_url()?>public/icomoon.css">
    <link rel="stylesheet" href="<?=base_url()?>public/css/bootstrap-social.css">
    <link rel="icon" href="<?=base_url()?>public/images/logo.ico">
