	...
	<div class="container">
		...
		<div class="collapse navbar-collapse">
			...
			<li><a href="<?=base_url()?>" class="smoothScroll"><span class="glyphicon glyphicon-th-list"></span></a>
					<ul class="dropdown">
						<li><a href="<?=base_url()?>Fundacion" class="smoothScroll">De la fundación</li></a>
						<li><a href="<?=base_url()?>Eje_Accion" class="smoothScroll">Ejes de acción <span class="glyphicon glyphicon-chevron-right"></span></a>
							<ul class="dropdown">
								<li><a href="<?=base_url()?>Eje_Accion#difusion" class="smoothScroll">Difusión Artística</li></a>
								<li><a href="<?=base_url()?>Eje_Accion#formacion" class="smoothScroll">Formación Artística</li></a>
								<li><a href="<?=base_url()?>Eje_Accion#profesion" class="smoothScroll">Profesionalización</li></a>
							</ul>
						</li>
						<li><a href="<?=base_url()?>Galeria" class="smoothScroll">Eventos</li></a>
						<li><a href="<?=base_url()?>Donacion" class="smoothScroll">Donaciones</li></a>
						<li><a href="<?=base_url()?>Contacto" class="smoothScroll">¡Contactenos!</li></a>
					</ul>
				</li>
