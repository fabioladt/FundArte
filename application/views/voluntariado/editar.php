...
<h3>Edición de Voluntariado</h3>
<div >
    <div class="col-lg-5 col-lg-offset-2">
      <h1 align="center">Editar Voluntariado</h1>
      <?php if(isset($_SESSION['success'])) {?>
        <div class="alert alert-success"><?php echo $_SESSION['success'];?></div>
      <?php } ?>
      <?php echo validation_errors('<div class="alert alert-danger">', '</div>'); ?>
      <form action="<?=base_url()?>voluntariado/update" method="POST">
      ...
      <div class="form-group">
        <label for="contraseña" >Descripcion: </label>
        <input class="form-control" name="desc" id="desc" type="text" value="<?php echo $eve->fecha_fin ?>">
      </div>
      ...
      <div class="form-group">
        ...
        <input class="form-control" name="estado" id="est" type="integer" value="<?php echo $eve->fecha_fin ?>">
      </div>

      <div class="form-group">
        <label for="contraseña" >Correo: </label>
        <input class="form-control" name="correo" id="correo" type="email" value="<?php echo $eve->fecha_fin ?>">
      </div>
